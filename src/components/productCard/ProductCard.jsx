...
function ProductCard() {
    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-6 py-8 md:py-15 mx-auto">
                <div className="lg:w-1/2 w-full mb-6 lg:mb-10">
                    ...
                    <div className="h-1 w-40 bg-pink-600 rounded"></div>
                </div>
                <div className="flex flex-wrap -m-1">
                    <div className="p-6 md:w-1/4  drop-shadow-lg " >
                    ...
                    </div><div className="p-6 md:w-1/4  drop-shadow-lg " >
                        <div className="h-full border-2 hover:shadow-gray-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out    border-gray-200 border-opacity-60 rounded-2xl overflow-hidden" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                            <div className="flex justify-center cursor-pointer" >
                                <img className=" rounded-2xl w-full h-80 p-2 hover:scale-110 transition-scale-110  duration-300 ease-in-out" src="https://dummyimage.com/720x400" alt="blog" />
                            </div>
